...
!function(a) {
    ...
    "use strict";
    var isSupportAmd = "function" == typeof define && define.amd, isFontInstalled = function(a) {
    ...
    if (!hasCodeMirror && isSupportAmd && "undefined" != typeof require)
        if (void 0 !== require.resolve)
            ...
            void 0 !== eval("require").specified && (hasCodeMirror = eval("require").specified("codemirror"));
    var isSupportTouch = "ontouchstart"in window || navigator.MaxTouchPoints > 0 || navigator.msMaxTouchPoints > 0
        ...
        var a = function(a) {
          ...
          , X = function(b, c) {
            ...
            if (0 === b.offset) {
                ...
                W(b.node) ? (d = b.node.childNodes[b.offset - 1],
                e = A(d)) : (d = b.node,
                e = c ? 0 : b.offset - 1);
            return {
                node: d,
          ...
          , Y = function(b, c) {
            ...
            if (A(b.node) === b.offset) {
                ...
                W(b.node) ? (d = b.node.childNodes[b.offset],
                e = 0) : (d = b.node,
                e = c ? A(b.node) : b.offset + 1);
            return {
                node: d,
                offset: e
            }
          ...
          , ua = function(a) {
            return a && !dom.isText(a) && list.contains(a.classList, "note-styletag")
        };
        return {
            NBSP_CHAR: NBSP_CHAR,
      ...
      , Context = function(a, b) {
        ...
        this.initializeModule = function(b) {
            ...
            c.shouldInitialize() && (c.initialize && c.initialize(),
        ...
        this.removeModule = function(b) {
            var c = this.modules[b];
            c.shouldInitialize() && (c.events && dom.detachEvents(a, c.events),
            c.destroy && c.destroy()),
        ...
        this.createInvokeHandlerAndUpdateState = function(a, b) {
            return function(d) {
                c.createInvokeHandler(a, b)(d),
                c.invoke("buttons.updateCurrentStyle")
            }
        }
        ,
        this.createInvokeHandler = function(a, b) {
            return function(d) {
                d.preventDefault();
                var e = $(d.target);
                c.invoke(a, b || e.closest("[data-value]").data("value"), e)
            }
        }
        ,
    ...
    $.fn.extend({
        summernote: function() {
            ...
            d.langInfo = $.extend(!0, {}, $.summernote.lang["en-US"], $.summernote.lang[d.lang]),
            d.icons = $.extend(!0, {}, $.summernote.options.icons, d.icons),
            d.tooltip = "auto" === d.tooltip ? !agent.isSupportTouch : d.tooltip,
            ...
            if (e.length) {
                ...
                if (b)
                    return f.invoke.apply(f, list.from(arguments));
    ...
    var Renderer = function(a, b, c, d) {
        this.render = function(e) {
            var f = $(a);
            if (c && c.contents && f.html(c.contents),
      ...
      , dropdown = renderer.create('<div class="dropdown-menu">', function(a, b) {
        var c = $.isArray(b.items) ? b.items.map(function(a) {
            ...
            return '<li><a href="#" data-value="' + c + '"' + (void 0 !== e ? ' data-option="' + e + '"' : "") + ">" + d + "</a></li>"
        }).join("") : b.items;
        a.html(c)
    })
      ...
      , ui = {
        ...
        options: {},
        button: function(a, b) {
            return renderer.create('<button type="button" class="note-btn btn btn-default btn-sm" tabindex="-1">', function(a, b) {
    ...
    var key = function() {
      ...
      , range = function() {
        var a = function(a, b) {
            ...
            if (0 !== c && dom.isText(g[c - 1])) {
                ...
                for (var k = j.text.replace(/[\r\n]/g, "").length; k > i.nodeValue.length && i.nextSibling; )
                    ...
                    i = i.nextSibling;
                i.nodeValue;
                b && i.nextSibling && dom.isText(i.nextSibling) && k === i.nodeValue.length && (k -= i.nodeValue.length,
                i = i.nextSibling),
                e = i,
                c = k
            }
          ...
          , c = function(a, d, e, f) {
            ...
            this.nodes = function(a, b) {
                ...
                return dom.walkPoint(e, f, function(b) {
                    if (!dom.isEditable(b.node)) {
                        var e;
                        d ? (dom.isLeftEdgePoint(b) && h.push(b.node),
                        dom.isRightEdgePoint(b) && list.contains(h, b.node) && (e = b.node)) : e = c ? dom.ancestor(b.node, a) : b.node,
                        e && a(e) && g.push(e)
                    }
                }, !0),
                list.unique(g)
            ...
            this.splitText = function() {
                ...
                dom.isText(a) && !dom.isEdgePoint(this.getStartPoint()) && (g.sc = a.splitText(d),
                g.so = 0,
                b && (g.ec = g.sc,
                g.eo = f - d)),
            ...
            this.wrapBodyInlineWithPara = function() {
                ...
                if (dom.isInline(b.sc)) {
                    ...
                    d = b.sc.childNodes[b.so > 0 ? b.so - 1 : 0];
                var f = dom.listPrev(d, dom.isParaInline).reverse();
                if (f = f.concat(dom.listNext(d.nextSibling, dom.isParaInline)),
                f.length) {
        ...
        return {
            create: function(a, b, d, e) {
                ...
                return f || 1 !== arguments.length ? f : (f = this.createFromNode(arguments[0]),
            ...
            createFromNode: function(a) {
                var b = a
                  ...
                  , d = a
                  , e = dom.nodeLength(d);
                return dom.isVoid(b) && (c = dom.listPrev(b).length - 1,
                b = b.parentNode),
                dom.isBR(d) ? (e = dom.listPrev(d).length - 1,
                d = d.parentNode) : dom.isVoid(d) && (e = dom.listPrev(d).length,
                d = d.parentNode),
                this.create(b, c, d, e)
            },
        ...
        this.current = function(a) {
            ...
            try {
                c = $.extend(c, {
                    ...
                    "font-family": document.queryCommandValue("fontname") || c["font-family"]
                })
            } catch (a) {}
            if (a.isOnList()) {
            ...
            if (f && f.style["line-height"])
                c["line-height"] = f.style.lineHeight;
            else {
      ...
      , Bullet = function() {
        ...
        this.wrapList = function(a, b) {
            ...
            f && (dom.appendChildNodes(g, list.from(f.childNodes)),
            dom.remove(f)),
            a
        }
        ,
        ...
        this.insertParagraph = function(b) {
            ...
            if (e) {
                ...
                if (dom.isEmpty(e) && dom.isPara(e) && dom.isBlockquote(e.parentNode))
                    ...
                    (dom.isHeading(d) || dom.isPre(d) || dom.isCustomStyleTag(d)) && dom.isEmpty(d) && (d = dom.replace(d, "p"))
                }
            } else {
      ...
      , TableResultAction = function(a, b, c, d) {
        function e() {
            return !a || !a.tagName || "td" !== a.tagName.toLowerCase() && "th" !== a.tagName.toLowerCase() ? void console.error("Impossible to identify start Cell point.", a) : (n.colPos = a.cellIndex,
        ...
        function k() {
            for (var a = d.rows, b = 0; b < a.length; b++)
                for (var c = a[b].cells, e = 0; e < c.length; e++)
                    i(a[b], c[e])
        }
        function l(a) {
            switch (b) {
        ...
        function m(a) {
            ...
            case TableResultAction.where.Column:
                ...
                if (a.isRowSpan && a.isVirtual)
                    return TableResultAction.resultAction.Ignore;
                break;
            case TableResultAction.where.Row:
                if (a.isRowSpan)
                    return TableResultAction.resultAction.SumSpanCount;
                if (a.isColSpan && a.isVirtual)
                    return TableResultAction.resultAction.Ignore
            }
            return TableResultAction.resultAction.AddCell
        }
        ...
        this.getActionList = function() {
            for (var a = b === TableResultAction.where.Row ? n.rowPos : -1, d = b === TableResultAction.where.Column ? n.colPos : -1, e = 0, f = !0; f; ) {
                var h = a >= 0 ? a : e
                  , i = d >= 0 ? d : e
                  , j = o[h];
                if (!j)
                ...
                if (!k)
                    return f = !1,
                    p;
                var q = TableResultAction.resultAction.Ignore;
                switch (c) {
    ...
    var Table = function() {
        ...
        this.addRow = function(a, b) {
            for (var c = dom.ancestor(a.commonAncestor(), dom.isCell), d = $(c).closest("tr"), e = this.recoverAttributes(d), f = $("<tr" + e + "></tr>"), g = new TableResultAction(c,TableResultAction.where.Row,TableResultAction.requestAction.Add,$(d).closest("table")[0]), h = g.getActionList(), i = 0; i < h.length; i++) {
                var j = h[i]
                  , k = this.recoverAttributes(j.baseCell);
                switch (j.action) {
                case TableResultAction.resultAction.AddCell:
                    f.append("<td" + k + ">" + dom.blank + "</td>");
                    break;
                case TableResultAction.resultAction.SumSpanCount:
                    if ("top" === b) {
                        if ((j.baseCell.parent ? j.baseCell.closest("tr").rowIndex : 0) <= d[0].rowIndex) {
                            var l = $("<div></div>").append($("<td" + k + ">" + dom.blank + "</td>").removeAttr("rowspan")).html();
                            f.append(l);
                            break
                        }
                    }
                    ...
                    m++,
                    j.baseCell.setAttribute("rowSpan", m)
                }
            }
            if ("top" === b)
                d.before(f);
                ...
                if (c.rowSpan > 1) {
                    var n = d[0].rowIndex + (c.rowSpan - 2);
                    return void $($(d).parent().find("tr")[n]).after($(f))
                }
                d.after(f)
            }
        }
        ,
        this.addCol = function(a, b) {
            var c = dom.ancestor(a.commonAncestor(), dom.isCell)
              , d = $(c).closest("tr");
            $(d).siblings().push(d);
            for (var e = new TableResultAction(c,TableResultAction.where.Column,TableResultAction.requestAction.Add,$(d).closest("table")[0]), f = e.getActionList(), g = 0; g < f.length; g++) {
                var h = f[g]
                  , i = this.recoverAttributes(h.baseCell);
                switch (h.action) {
                case TableResultAction.resultAction.AddCell:
                    "right" === b ? $(h.baseCell).after("<td" + i + ">" + dom.blank + "</td>") : $(h.baseCell).before("<td" + i + ">" + dom.blank + "</td>");
                    break;
                case TableResultAction.resultAction.SumSpanCount:
                    if ("right" === b) {
                        var j = parseInt(h.baseCell.colSpan, 10);
                        j++,
                        h.baseCell.setAttribute("colSpan", j)
                    } else
                        $(h.baseCell).before("<td" + i + ">" + dom.blank + "</td>")
                }
            }
        }
        ,
        this.recoverAttributes = function(a) {
            ...
            for (var c = a.attributes || [], d = 0; d < c.length; d++)
                "id" !== c[d].name.toLowerCase() && c[d].specified && (b += " " + c[d].name + "='" + c[d].value + "'");
            return b
        }
        ,
        this.deleteRow = function(a) {
            for (var b = dom.ancestor(a.commonAncestor(), dom.isCell), c = $(b).closest("tr"), d = c.children("td, th").index($(b)), e = c[0].rowIndex, f = new TableResultAction(b,TableResultAction.where.Row,TableResultAction.requestAction.Delete,$(c).closest("table")[0]), g = f.getActionList(), h = 0; h < g.length; h++)
                if (g[h]) {
                    var i = g[h].baseCell
                      , j = g[h].virtualTable
                      , k = i.rowSpan && i.rowSpan > 1
                      , l = k ? parseInt(i.rowSpan, 10) : 0;
                    switch (g[h].action) {
                    ...
                    case TableResultAction.resultAction.AddCell:
                        ...
                        var n = c[0].cells[d];
                        k && (l > 2 ? (l--,
                        m.insertBefore(n, m.cells[d]),
                        m.cells[d].setAttribute("rowSpan", l),
                        m.cells[d].innerHTML = "") : 2 === l && (m.insertBefore(n, m.cells[d]),
                        m.cells[d].removeAttribute("rowSpan"),
                        m.cells[d].innerHTML = ""));
                        continue;
                    case TableResultAction.resultAction.SubtractSpanCount:
                        k && (l > 2 ? (l--,
                        i.setAttribute("rowSpan", l),
                        j.rowIndex !== e && i.cellIndex === d && (i.innerHTML = "")) : 2 === l && (i.removeAttribute("rowSpan"),
                        j.rowIndex !== e && i.cellIndex === d && (i.innerHTML = "")));
                        continue;
        ...
        ,
        this.deleteCol = function(a) {
            for (var b = dom.ancestor(a.commonAncestor(), dom.isCell), c = $(b).closest("tr"), d = c.children("td, th").index($(b)), e = new TableResultAction(b,TableResultAction.where.Column,TableResultAction.requestAction.Delete,$(c).closest("table")[0]), f = e.getActionList(), g = 0; g < f.length; g++)
                if (f[g])
                    switch (f[g].action) {
                    case TableResultAction.resultAction.Ignore:
                        continue;
                    case TableResultAction.resultAction.SubtractSpanCount:
                        var h = f[g].baseCell
                          , i = h.colSpan && h.colSpan > 1;
                        if (i) {
                            var j = h.colSpan ? parseInt(h.colSpan, 10) : 0;
                            j > 2 ? (j--,
                            h.setAttribute("colSpan", j),
                            h.cellIndex === d && (h.innerHTML = "")) : 2 === j && (h.removeAttribute("colSpan"),
                            h.cellIndex === d && (h.innerHTML = ""))
                        }
                        continue;
                    case TableResultAction.resultAction.RemoveCell:
                        dom.remove(f[g].baseCell, !0);
                        continue
                    }
        }
        ,
        ...
        ,
        this.deleteTable = function(a) {
            var b = dom.ancestor(a.commonAncestor(), dom.isCell);
        ...
        this.initialize = function() {
            ...
            f.airMode || (f.width && d.outerWidth(f.width),
        ...
        this.handleKeyMap = function(b) {
            ...
            var g = c[d.join("+")];
            g ? (b.preventDefault(),
            a.invoke(g)) : key.isEdit(b.keyCode) && this.afterCommand()
        }
        ,
        ...
        , q = ["bold", "italic", "underline", "strikethrough", "superscript", "subscript", "justifyLeft", "justifyCenter", "justifyRight", "justifyFull", "formatBlock", "removeFormat", "backColor", "foreColor", "fontName"], r = 0, s = q.length; r < s; r++)
            this[q[r]] = function(a) {
                return function(b) {
                    o(),
        ...
        this.tab = function() {
            ...
            a.isCollapsed() && a.isOnCell() ? k.tab(a) : (o(),
            l.insertTab(a, f.tabSize),
            p())
        }
        ,
        ...
        this.insertImage = function(b, c) {
            return async.createImage(b, c).then(function(a) {
                o(),
                "function" == typeof c ? c(a) : ("string" == typeof c && a.attr("data-filename", c),
        ...
        this.formatBlock = this.wrapCommand(function(b, c) {
            var d = a.options.callbacks.onApplyCustomStyle;
            d ? d.call(this, c, a, this.onFormatBlock) : this.onFormatBlock(b)
        }),
        ...
        this.fontSize = function(a) {
            ...
            if (b && b.isCollapsed()) {
                ...
                d && !dom.nodeLength(d) && (d.innerHTML = dom.ZERO_WIDTH_NBSP_CHAR,
        ...
        this.getLinkInfo = function() {
            ...
            return b.length && (c.isNewWindow = "_blank" === b.attr("target")),
            c
        }
        ,
        ...
        this.addRow = function(a) {
            var b = this.createRange(e);
            b.isCollapsed() && b.isOnCell() && (o(),
            k.addRow(b, a),
            p())
        }
        ,
        ...
        this.deleteRow = function() {
            var a = this.createRange(e);
            a.isCollapsed() && a.isOnCell() && (o(),
            k.deleteRow(a),
            p())
        }
        ,
        ...
        this.events = {
            "summernote.keydown": function(c, d) {
                b.needKeydownHook() && (d.ctrlKey || d.metaKey) && d.keyCode === key.code.V && (a.invoke("editor.saveRange"),
                b.$paste.focus(),
                setTimeout(function() {
                    b.pasteByHook()
                }, 0))
        ...
        ,
        this.destroy = function() {
            this.needKeydownHook() && (this.$paste.remove(),
            this.$paste = null)
        }
        ,
        this.pasteByHook = function() {
            var b = this.$paste[0].firstChild
              , c = b && b.src;
            if (dom.isImg(b) && 0 === c.indexOf("data:")) {
                for (var d = atob(b.src.split(",")[1]), e = new Uint8Array(d.length), f = 0; f < d.length; f++)
                    e[f] = d.charCodeAt(f);
                var g = new Blob([e],{
                    type: "image/png"
                });
        ...
        this.pasteByEvent = function(b) {
            ...
            if (c && c.items && c.items.length) {
                ...
                "file" === d.kind && -1 !== d.type.indexOf("image/") && a.invoke("editor.insertImagesOrCallback", [d.getAsFile()]),
        ...
        this.attachDragAndDropEvent = function() {
            ...
            g.onDragenter = function(b) {
                ...
                d || e.length || !g || (c.addClass("dragover"),
                h.width(c.width()),
                h.height(c.height()),
            ...
            h.on("drop", function(b) {
                ...
                c && c.files && c.files.length ? (b.preventDefault(),
                d.focus(),
                a.invoke("editor.insertImagesOrCallback", c.files)) : $.each(c.types, function(b, d) {
                    var e = c.getData(d);
    ...
    var Codeview = function(a) {
        ...
        this.activate = function() {
            if (d.val(dom.html(c, e.prettifyHtml)),
            d.height(c.height()),
      ...
      , Statusbar = function(a) {
        var b = $(document)
          ...
          , e = a.options;
        this.initialize = function() {
            if (e.airMode || e.disableResizeEditor)
            ...
            c.on("mousedown", function(a) {
                ...
                b.on("mousemove", f).one("mouseup", function() {
                    b.off("mousemove", f)
                })
            })
        }
      ...
      , Fullscreen = function(a) {
        ...
        this.toggle = function() {
            ...
            this.isFullscreen() ? (e.data("orgHeight", e.css("height")),
            g.on("resize", this.onResize).trigger("resize"),
            h.css("overflow", "hidden")) : (g.off("resize", this.onResize),
            this.resizeTo({
                h: e.data("orgHeight")
            }),
      ...
      , Handle = function(a) {
        ...
        this.initialize = function() {
            ...
            this.$handle.on("mousedown", function(d) {
                if (dom.isControlSizing(d.target)) {
                    ...
                    c.on("mousemove", h).one("mouseup", function(b) {
                        b.preventDefault(),
                        c.off("mousemove", h),
                        a.invoke("editor.afterCommand")
                    }),
        ...
        this.update = function(b) {
            ...
            if (a.invoke("imagePopover.update", b),
            c) {
                var e = $(b)
                  , f = e.position()
                  , g = {
      ...
      , AutoLink = function(a) {
        var b = this
          , c = /^([A-Za-z][A-Za-z0-9+-.]*\:[\/\/]?|mailto:[A-Z0-9._%+-]+@)?(www\.)?(.+)$/i;
        this.events = {
        ...
        this.replace = function() {
            if (this.lastWordRange) {
                ...
                if (d && (d[1] || d[2])) {
                    var e = d[1] ? b : "http://" + b
                      , f = $("<a />").html(b).attr("href", e)[0];
                    this.lastWordRange.insertNode(f),
                    this.lastWordRange = null,
                    a.invoke("editor.focus")
                }
            }
      ...
      , Buttons = function(a) {
        var b = this
          ...
          , h = this.representShortcut = function(a) {
            var b = g[a];
            return e.shortcuts && b ? (agent.isMac && (b = b.replace("CMD", "⌘").replace("SHIFT", "⇧")),
        ...
        this.addToolbarButtons = function() {
            ...
            a.memo("button.bold", function() {
                return c.button({
                    ...
                    click: a.createInvokeHandlerAndUpdateState("editor.bold")
                }).render()
            }),
            a.memo("button.italic", function() {
                return c.button({
                    ...
                    click: a.createInvokeHandlerAndUpdateState("editor.italic")
                }).render()
            }),
            a.memo("button.underline", function() {
                return c.button({
                    ...
                    click: a.createInvokeHandlerAndUpdateState("editor.underline")
                }).render()
            }),
            ...
            a.memo("button.strikethrough", function() {
                return c.button({
                    ...
                    click: a.createInvokeHandlerAndUpdateState("editor.strikethrough")
                }).render()
            }),
            a.memo("button.superscript", function() {
                return c.button({
                    ...
                    click: a.createInvokeHandlerAndUpdateState("editor.superscript")
                }).render()
            }),
            a.memo("button.subscript", function() {
                return c.button({
                    ...
                    click: a.createInvokeHandlerAndUpdateState("editor.subscript")
                }).render()
            }),
            a.memo("button.fontname", function() {
                return c.buttonGroup([c.button({
                    ...
                    click: a.createInvokeHandlerAndUpdateState("editor.fontName")
                })]).render()
            }),
        ...
        this.addTablePopoverButtons = function() {
            a.memo("button.addRowUp", function() {
                return c.button({
                    className: "btn-md",
                    contents: c.icon(e.icons.rowAbove),
                    tooltip: f.table.addRowAbove,
                    click: a.createInvokeHandler("editor.addRow", "top")
                }).render()
            }),
            a.memo("button.addRowDown", function() {
                return c.button({
                    className: "btn-md",
                    contents: c.icon(e.icons.rowBelow),
                    tooltip: f.table.addRowBelow,
                    click: a.createInvokeHandler("editor.addRow", "bottom")
                }).render()
            }),
            a.memo("button.addColLeft", function() {
                return c.button({
                    className: "btn-md",
                    contents: c.icon(e.icons.colBefore),
                    tooltip: f.table.addColLeft,
                    click: a.createInvokeHandler("editor.addCol", "left")
                }).render()
            }),
            a.memo("button.addColRight", function() {
                return c.button({
                    className: "btn-md",
                    contents: c.icon(e.icons.colAfter),
                    tooltip: f.table.addColRight,
                    click: a.createInvokeHandler("editor.addCol", "right")
                }).render()
            }),
            a.memo("button.deleteRow", function() {
                return c.button({
                    className: "btn-md",
                    contents: c.icon(e.icons.rowRemove),
                    tooltip: f.table.delRow,
                    click: a.createInvokeHandler("editor.deleteRow")
                }).render()
            }),
            a.memo("button.deleteCol", function() {
                return c.button({
                    className: "btn-md",
                    contents: c.icon(e.icons.colRemove),
                    tooltip: f.table.delCol,
                    click: a.createInvokeHandler("editor.deleteCol")
                }).render()
            }),
            a.memo("button.deleteTable", function() {
                return c.button({
                    className: "btn-md",
                    contents: c.icon(e.icons.trash),
                    tooltip: f.table.delTable,
                    click: a.createInvokeHandler("editor.deleteTable")
                }).render()
            })
        }
        ,
      ...
      , LinkDialog = function(a) {
        ...
        this.initialize = function() {
            var a = e.dialogsInBody ? $(document.body) : d
              , b = '<div class="form-group"><label>' + f.link.textToDisplay + '</label><input class="note-link-text form-control" type="text" /></div><div class="form-group"><label>' + f.link.url + '</label><input class="note-link-url form-control" type="text" value="http://" /></div>' + (e.disableLinkTarget ? "" : '<div class="checkbox"><label for="sn-checkbox-open-in-new-window"><input type="checkbox" id="sn-checkbox-open-in-new-window" checked />' + f.link.openInNewWindow + "</label></div>")
        ...
        this.showLinkDialog = function(d) {
            return $.Deferred(function(e) {
                ...
                c.onDialogShown(b.$dialog, function() {
                    ...
                    b.bindEnterKey(g, h),
                    b.bindEnterKey(f, h);
                    var k = void 0 !== d.isNewWindow ? d.isNewWindow : a.options.linkTargetBlank;
                    i.prop("checked", k),
      ...
      , ImagePopover = function(a) {
        ...
        this.shouldInitialize = function() {
            return !list.isEmpty(d.popover.image)
        }
        ,
        this.initialize = function() {
            this.$popover = c.popover({
            ...
            var b = this.$popover.find(".popover-content");
            a.invoke("buttons.build", b, d.popover.image)
        }
        ,
        this.destroy = function() {
            this.$popover.remove()
      ...
      , TablePopover = function(a) {
        ...
        this.shouldInitialize = function() {
            return !list.isEmpty(d.popover.table)
        }
        ,
        this.initialize = function() {
            this.$popover = c.popover({
            ...
            var b = this.$popover.find(".popover-content");
            a.invoke("buttons.build", b, d.popover.table),
            agent.isFF && document.execCommand("enableInlineTableEditing", !1, !1)
        }
        ,
        this.destroy = function() {
            this.$popover.remove()
        ...
        this.update = function(b) {
            ...
            var c = dom.isCell(b);
            if (c) {
                var d = dom.posFromPlaceholder(b);
                this.$popover.css({
                    display: "block",
                    left: d.left,
                    top: d.top
      ...
      , VideoDialog = function(a) {
        ...
        this.createVideoNode = function(a) {
            ...
            if (d && 11 === d[1].length) {
                var y = d[1];
                b = $("<iframe>").attr("frameborder", 0).attr("src", "//www.youtube.com/embed/" + y).attr("width", "640").attr("height", "360")
            } else if (f && f[0].length)
                b = $("<iframe>").attr("frameborder", 0).attr("src", "https://instagram.com/p/" + f[1] + "/embed/").attr("width", "612").attr("height", "710").attr("scrolling", "no").attr("allowtransparency", "true");
            else if (h && h[0].length)
                b = $("<iframe>").attr("frameborder", 0).attr("src", h[0] + "/embed/simple").attr("width", "600").attr("height", "600").attr("class", "vine-embed");
            else if (j && j[3].length)
                b = $("<iframe webkitallowfullscreen mozallowfullscreen allowfullscreen>").attr("frameborder", 0).attr("src", "//player.vimeo.com/video/" + j[3]).attr("width", "640").attr("height", "360");
            else if (l && l[2].length)
                b = $("<iframe>").attr("frameborder", 0).attr("src", "//www.dailymotion.com/embed/video/" + l[2]).attr("width", "640").attr("height", "360");
            else if (n && n[1].length)
                b = $("<iframe webkitallowfullscreen mozallowfullscreen allowfullscreen>").attr("frameborder", 0).attr("height", "498").attr("width", "510").attr("src", "//player.youku.com/embed/" + n[1]);
            else if (p && p[1].length || r && r[2].length) {
                var z = p && p[1].length ? p[1] : r[2];
                b = $("<iframe webkitallowfullscreen mozallowfullscreen allowfullscreen>").attr("frameborder", 0).attr("height", "310").attr("width", "500").attr("src", "http://v.qq.com/iframe/player.html?vid=" + z + "&amp;auto=0")
            } else {
                if (!(t || v || x))
                    return !1;
      ...
      , HelpDialog = function(a) {
        ...
        this.initialize = function() {
            var a = e.dialogsInBody ? $(document.body) : d
              , b = ['<p class="text-center">', '<a href="http://summernote.org/" target="_blank">Summernote 0.8.6</a> · ', '<a href="https://github.com/summernote/summernote" target="_blank">Project</a> · ', '<a href="https://github.com/summernote/summernote/issues" target="_blank">Issues</a>', "</p>"].join("");
            this.$dialog = c.dialog({
      ...
      , HintPopover = function(a) {
        ...
        this.replace = function() {
            ...
            if (b.length) {
                ...
                this.lastWordRange = null,
                this.hide(),
                a.triggerEvent("change", a.layoutInfo.editable.html(), a.layoutInfo.editable),
                a.invoke("editor.focus")
            }
        }
        ,
        ...
        this.handleKeydown = function(a) {
            this.$popover.is(":visible") && (a.keyCode === key.code.ENTER ? (a.preventDefault(),
            this.replace()) : a.keyCode === key.code.UP ? (a.preventDefault(),
            this.moveUp()) : a.keyCode === key.code.DOWN && (a.preventDefault(),
            this.moveDown()))
        }
        ,
        ...
        this.createGroup = function(a, c) {
            ...
            return this.searchKeyword(a, c, function(c) {
                c = c || [],
                c.length && (d.html(b.createItemTemplates(a, c)),
                b.show())
            }),
            d
        }
